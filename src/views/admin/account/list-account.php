...
<?php if ($total_page > 1) { ?>
    <div class="page-number">
        ...
        ?>
            <a class="number-of-page" href="index.php?page=listaccounts&pageNumber=<?= $current_page - 1 ?>"><i class="fa-solid fa-angle-left"></i></a>
        <?php }
        ?>
        ...
        ?>
                ...
                <?php } else if ($index > ($current_page - 3) && $index < ($current_page + 3)) { //Nếu là trang ở giữa, thì hiện 2 trang trước đó và 2 trang sau đó
                ?>
                    <a class="number-of-page" href="index.php?page=listaccounts&pageNumber=<?= $index ?>">
                        <?= $index ?>
                    </a>
        ...
        ?>
            <a class="number-of-page" href="index.php?page=listaccounts&pageNumber=<?= $current_page + 1 ?>"><i class="fa-solid fa-angle-right"></i></a>
